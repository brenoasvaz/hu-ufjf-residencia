...
async function seed() {
  ...
  // Reuniões clínicas de 2026 (março a dezembro)
  const meetings = [
    // MARÇO 2026
    ...
    { data: "2026-05-22", tema: "Primeira prova teórica R1, R2 E R3 (Joelho + Pé e Tornozelo + Pediátrica)", tipo: "PROVA", preceptor: null, residente: null },
    ...
    { data: "2026-08-14", tema: "Segunda prova teórica R1, R2 E R3 (Mão + Tumor + Ombro e Cotovelo)", tipo: "PROVA", preceptor: null, residente: null },
    ...
    { data: "2026-11-12", tema: "Apresentação de Artigo", tipo: "ARTIGO", preceptor: "Dra. Adriano Mendes", residente: "R2" },
    ...
    { data: "2026-11-27", tema: "Terceira prova teórica R1, R2 E R3 (Quadril + Coluna + Ciência básica e Dor)", tipo: "PROVA", preceptor: null, residente: null },
    ...
    { data: "2026-12-12", tema: "Sábado: Simulado Prova Oral, Exame Físico e Habilidades", tipo: "AVALIACAO", preceptor: null, residente: null },
    
    // FEVEREIRO 2027 (início do próximo ano letivo)
    { data: "2027-02-05", tema: "Abertura do ano letivo", tipo: "EVENTO", preceptor: "Dr. Jair Moreira", residente: null },
    { data: "2027-02-05", tema: "Apresentação das escalas e semana padrão", tipo: "EVENTO", preceptor: "Dr. Breno Vaz", residente: null },
    { data: "2027-02-05", tema: "Joelho - Lesões ligamentares do Joelho", tipo: "AULA", preceptor: "Dr. Bruno Fajardo", residente: null },
    { data: "2027-02-12", tema: "Instabilidade Patelar", tipo: "AULA", preceptor: "Dr. Sávio Mourão", residente: null },
    { data: "2027-02-12", tema: "Apresentação de artigo", tipo: "ARTIGO", preceptor: "Dr. Sávio Mourão", residente: "R2" },
    { data: "2027-02-12", tema: "Casos clínicos", tipo: "CASOS_CLINICOS", preceptor: "Dr. Sávio Mourão", residente: "R1, R3" },
    { data: "2027-02-19", tema: "Joelho - Lesões Meniscais", tipo: "AULA", preceptor: "Dr. Bruno Fajardo", residente: null },
    { data: "2027-02-19", tema: "Apresentação de artigo", tipo: "ARTIGO", preceptor: "Dr. Bruno Fajardo", residente: "R2" },
    { data: "2027-02-19", tema: "Casos clínicos", tipo: "CASOS_CLINICOS", preceptor: "Dr. Bruno Fajardo", residente: "R1, R3" },
    { data: "2027-02-26", tema: "Pé e Tornozelo - Pé Diabético", tipo: "AULA", preceptor: "Dr. João Paulo", residente: null },
    { data: "2027-02-26", tema: "Apresentação de Artigo", tipo: "ARTIGO", preceptor: "Dr. João Paulo", residente: "R2" },
    { data: "2027-02-26", tema: "Casos clínicos", tipo: "CASOS_CLINICOS", preceptor: "Dr. João Paulo", residente: "R1, R3" },
    { data: "2027-02-27", tema: "Reunião de apresentação dos novos residentes - auditório 2º andar 08:00h", tipo: "EVENTO", preceptor: null, residente: null },
  ];

  let insertCount = 0;
  for (const m of meetings) {
    await connection.execute(
      `INSERT INTO clinical_meetings (data, tema, tipo, preceptor, residente_apresentador) VALUES (?, ?, ?, ?, ?)`,
      [m.data, m.tema, m.tipo, m.preceptor, m.residente]
    );
    insertCount++;
  }
